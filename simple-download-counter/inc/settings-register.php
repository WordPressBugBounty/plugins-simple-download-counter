...
function simple_download_counter_register_settings() {
	...
	add_settings_field('micro_api',     __('Enable Micro API', 'simple-download-counter'), 'simple_download_counter_callback_checkbox',      'download_counter_options', 'settings', array('id' => 'micro_api',     'section' => 'settings', 'label' => esc_html__('Make all download counts publicly accessible via URL request', 'simple-download-counter')));
